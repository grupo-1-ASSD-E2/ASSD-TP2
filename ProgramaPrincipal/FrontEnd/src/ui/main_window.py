...
"}")
        ...
        self.progress_bar = QtWidgets.QProgressBar(self.widget_4)
...
"")
        ...
        self.note_area.setGeometry(QtCore.QRect(0, 0, 616, 380))
    ...
    def retranslateUi(self, AudioTool):
        ...
        self.progress_bar.setFormat(_translate("AudioTool", "%p%"))
        ...
        self.sintetizar.setText(_translate("AudioTool", "Synthetis"))
        ...
        self.discard_effect.setText(_translate("AudioTool", "Discard"))
